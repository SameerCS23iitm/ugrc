...
plt.grid(alpha=0.2)
plt.tight_layout()
plt.savefig(OBS_DIR + 'recon_hist_lstm_autoenc.png', dpi=150, bbox_inches='tight')
plt.show()
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(OBS_DIR + 'pr_curve_lstm_autoenc.png', dpi=150, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(OBS_DIR + 'con_matrix_lstm_autoenc.png', dpi=150, bbox_inches='tight')
plt.show()
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(OBS_DIR + 'roc_lstm_autoenc.png', dpi=150, bbox_inches='tight')
plt.show()
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig(OBS_DIR + 'losses_lstm_autoenc.png', dpi=150, bbox_inches='tight')
plt.show()
